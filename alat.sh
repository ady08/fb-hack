...
echo "\033[36;1m[]___________ -H O R A S  H I T A  S U D E- ___________[]"|lolcat
echo "\033[36;1m[]=====================================================[]"|lolcat
echo "\033[36;1m[]=====================================================[]"|lolcat
echo "\033[37;1m[] AUTHOR :  Edy Naibaho                               []"|lolcat
echo "\033[35;1m[] W A    :   Masih Dalam Pembuatan                    []"|lolcat
echo "\033[36;1m[] Facebook  : Edy Naibaho                             []"|lolcat
echo "\033[31;1m[] Thanks To : Nicoleus Sitorus                        []"|lolcat
echo "\033[31;1m[] My Team   : SAMOSIR CYBER TEAM                      []"|lolcat
echo "\033[31;1m[] PESAN  : GUNAKAN TOOLS INI DENGAN BIJAK             []"|lolcat
echo "\033[36;1m[]=====================================================[]"|lolcat
echo "\033[36;1m-------=========[ KEPERLUAN ALAT ONLINE ]========------"|lolcat

                       echo $red"            ____===____===____ MENU ____===____===____"|lolcat
                       echo $red"                     __-H O R A S-__"|lolcat
...
clear
echo $blue"HORAS PASSWORD NYA ??"|lolcat
echo $blue"BILA TIDAK TAU MAKA AKAN KEMBALI LAGI SEMULA"|lolcat
echo $blue"PASSWORDNYA ( nicoleus ) ITU GAN"|lolcat
echo $blue"WKWKWKWKKWKWK"|lolcat
echo "\033[33;1m"
...
echo "      \033[32;1m[\033[31;1m!\033[32;1m]\033[34;1m----\033[35;1m[ \033[31;1mPassword Salah BABI\033[35;1m]\033[34;1m----\033[32;1m[\033[31;1m!\033[32;1m]"
sleep 1
clear
sh alat.sh
fi
...
then
clear
echo "HORAS SAMPAI JUMPA LAGI LAE KU"|lolcat
echo " JANGAN LUPA SHARE TOOLS INI OK"|lolcat
echo "GUNAKAN LAH DENGAN BIJAK KONTOL"|lolcat
echo " INGAT JANGAN DI RECODE YA BANGSAT"|lolcat
echo "H O R A S"|lolcat
exit
logout
fi
